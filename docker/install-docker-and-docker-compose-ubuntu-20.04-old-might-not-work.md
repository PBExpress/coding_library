# Install Docker & Docker Compose (Ubuntu) 20.04 (Old Might not work)

#### Careful Tyler might not work on all <a href="#introduction" id="introduction"></a>
...
### Install Compose as standalone binary on Linux systems <a href="#install-compose-as-standalone-binary-on-linux-systems" id="install-compose-as-standalone-binary-on-linux-systems"></a>
...
### Step 6 — Committing Changes in a Container to a Docker Image <a href="#step-7-committing-changes-in-a-container-to-a-docker-image" id="step-7-committing-changes-in-a-container-to-a-docker-image"></a>
...
### Step 7 — Pushing Docker Images to a Docker Repository <a href="#step-8-pushing-docker-images-to-a-docker-repository" id="step-8-pushing-docker-images-to-a-docker-repository"></a>
